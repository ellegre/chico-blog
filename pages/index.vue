    ...
    <section class="bg-gray-200 py-10">
      <div class="max-w-lg mx-auto lg:max-w-5xl xl:px-12">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 space-x-2 place-items-center">
          <div class="relative w-56 mb-5">
            <div class="absolute rounded-xl -right-3 -bottom-3 bg-gradient-to-r from-brand-light to-brand h-full w-full"></div>
            <div class="bg-gray-800 text-gray-50 relative rounded-xl p-6 h-72">
              <div class="h-2 w-20 bg-brand mb-3"></div>
              <div class="text-2xl md:text-3xl font-extrabold text-white">100%</div>
              <p class="mb-3 text-white text-xl md:text-2xl">Loyalty</p>
              <p class="text-gray-400">To the owner, especially if the owner is eating something at the moment</p>
            </div>
          </div>
          <div class="relative w-56 mb-5">
            <div class="absolute rounded-xl -right-3 -bottom-3 bg-gradient-to-r from-yellow-100 to-yellow-500 h-full w-full"></div>
            <div class="bg-gray-800 text-gray-50 relative rounded-xl p-6 h-72">
              <div class="h-2 w-20 bg-yellow-300 mb-3"></div>
              <div class="text-4xl font-extrabold text-white">82%</div>
              <p class="mb-3 text-white text-2xl">Energy saving</p>
              <p class="text-gray-400">Energy of the dog is spared during the day thanks to constant sleep</p>
            </div>
          </div>
          <div class="relative w-56 mb-5">
            <div class="absolute rounded-xl -right-3 -bottom-3 bg-gradient-to-r from-purple-100 to-purple-300 h-full w-full"></div>
            <div class="bg-gray-800 text-gray-50 relative rounded-xl p-6 h-72">
              <div class="h-2 w-20 bg-purple-400 mb-3"></div>
              <div class="text-4xl font-extrabold text-white">97%</div>
              <p class="mb-3 text-white text-2xl">Cleanness</p>
              <p class="text-gray-400">As the universal cleaner Chico can be used on different floor coverings. He effortlessly removes any edible particles that fall on the floor</p>
            </div>
          </div>
        </div>
      </div>
